...
$jscomp.polyfill = function (d, r, q, n) {
    if (r) {
        ...
        n = q[d];
        r = r(n);
        r != n && null != r && $jscomp.defineProperty(q, d, {
            configurable: !0,
            writable: !0,
            value: r
        })
        ...
        function d(r, q, n) {
            function u(e, b) {
                if (!q[e]) {
                    ...
                    r[e][0].call(b.exports, function (b) {
                        return u(r[e][1][b] || b)
                    }, b, b.exports, d, r, q, n)
                }
                return q[e].exports
            ...
            function b(a) {
                ...
                return function () {
                    ...
                    if (c) {
                        ...
                        k = Reflect.construct(k, arguments,
                            g)
            ...
            d = function () {
                ...
                u(d, [{
                    ...
                    value: function (d, e) {
                        ...
                        if (-1 === h.startIx) this._fileData.splice(h.insertIx || 0, 0, {
                            offset: d,
                            data: e
                        });
                        else {
                    ...
                    value: function (d, e) {
                        ...
                        for (f = l; f < this._fileData.length && !(h = this._fileData[f].offset, b = h + this._fileData[f].data.length, e >= h - 1 && (t = f), e <= b + 1); f++); - 1 === t && (t = l);
                        return {
                            startIx: l,
                            endIx: t
                        }
            ...
            d = function (k) {
                ...
                v(g, [{
                    ...
                    value: function (c, g, k) {
                        ...
                        } else -1 !== a.indexOf(m) ? (e = g + 4, c.loadRange([e, e + w], {
                            onSuccess: function () {
                                b._pictureOffset = e;
                                b._nextBlock(c, g, m, w, k)
                            }
        ...
        7: [function (d, r, q) {
            ...
            d = function (m) {
                ...
                v(f, [{
                    ...
                    value: function (a) {
                        return "TAG" ===
                            String.fromCharCode.apply(String, a.slice(0, 3))
                    }
                }]);
                return f
            }(q);
                    ...
                    value: function (b, a, c, k, g) {
                        for (var f = {}, d = this._getFrameHeaderSize(k); b < a - d;) {
                            ...
                            if (!g || -1 !== g.indexOf(m)) {
                                ...
                                l && l.format.unsynchronisation && !k.flags.unsynchronisation && (n = this.getUnsyncFileReader(n,
                                    p, t), p = 0, t = n.getSize());
            ...
            function b(b) {
                ...
                return function () {
                    ...
                    if (a) {
                        ...
                        c = Reflect.construct(c, arguments,
                            f)
                    } else c = c.apply(this, arguments);
                ...
                v(a, [{
                    ...
                    value: function (a, b) {
                        ...
                        p.flags.unsynchronisation &&
                            (a = t.getUnsyncFileReader(a, g, l), g = 0, b = a.getSize());
                    ...
                    value: function (a, b) {
                        for (var c = 0, g; g = b[c]; c++)
                            if (g in a) return a = a[g] instanceof Array ? a[g][0] : a[g], a.data
                    }
                }, {
                    key: "getShortcuts",
                    value: function () {
            ...
            d = function (a) {
                ...
                v(c, [{
                        ...
                        if (b >= a.getSize()) f.onSuccess();
                            ...
                            if (0 == e || isNaN(e)) f.onSuccess();
                                ...
                                if (this._isContainerAtom(h)) {
                                    "meta" == h && (b += 4);
                                    var d = (c ? c + "." : "") + h;
                                    "moov.udta.meta.ilst" === d ? a.loadRange([b, b + e], f) : a.loadRange([b + 8, b + 8 + 8], {
                                        onSuccess: function () {
                    ...
                    value: function (a, b) {
                        ...
                        for (var g in f) f.hasOwnProperty(g) && (b = c[f[g]]) && (c[g] = "track" === g ? b.data.track :
                            b.data);
                        return {
                            type: "MP4",
                    ...
                    value: function (a, b) {
                        ...
                        if ("trkn" == g) var e = {
                            ...
                            switch (f) {
                                ...
                                case "int":
                                case "uint":
                                    e = ("int" == f ? 1 == h ? a.getSByteAt : 2 == h ? a.getSShortAt : 4 == h ? a.getSLongAt :
                                        a.getLongAt : 1 == h ? a.getByteAt : 2 == h ? a.getShortAt : a.getLongAt).call(a, b + (8 == h ? 4 : 0), !0);
                                    break;
                                case "jpeg":
                                case "png":
                                    e = {
                ...
                u(e, [{
                    ...
                    value: function (b, e, d) {
                        ...
                        switch ((d || "").toLowerCase()) {
                            ...
                            case "utf-16be":
                                d =
                                    p.readUTF16String(b, "utf-16be" === d);
                                break;
                            case "utf-8":
            ...
            r.exports = {
                readUTF16String: function (e, b, d) {
                    ...
                    for (var f = 0; h < d; f++) {
                        ...
                        h += 2;
                        if (0 == c) break;
                        else 216 > a || 224 <= a ? b[f] = String.fromCharCode(c) :
                            (a = (e[h + n] << 8) + e[h + m], h += 2, b[f] = String.fromCharCode(c, a))
                    }
                ...
                v(c, [{
                    ...
                    value: function (a) {
                        if (a = this._getResponseHeader(a, "Content-Range")) {
                            ...
                            if (!b) throw Error("FIXME: Unknown Content-Range syntax: " +
                                a);
                            return {
            ...
            var t =
                ...
                g = function () {
                    ...
                    v(a, [{
                        ...
                        value: function (a) {
                            var b =
                                new(this._getFileReader())(this._file),
                                c = this;
                            b.init({
                                onSuccess: function () {
                                    c._getTagReader(b, {
